            ...
            try {
                ...
                const clientInfo = `
                    <div class="client-details">
                      ...
                      <a href="" class="see-details edit-client" data-id="${details._id}">Edit</a> <a href="#" class="see-details change-status" data-id="${details._id}">Make ${details.client_status === "Inactive" ? "Active" : "Inactive"}</a> <a href="" class="see-details delete-client" data-id="${details._id}">Delete</a>     
                    </div>
                    `;
